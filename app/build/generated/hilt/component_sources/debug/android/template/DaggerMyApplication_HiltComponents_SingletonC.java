...
import android.template.ui.MedicationDao;
import android.template.ui.MedicationDatabase;
import android.template.ui.MedicationReminderReceiver;
import android.template.ui.MedicationReminderReceiver_MembersInjector;
import android.template.ui.MedicationViewModel;
import android.template.ui.MedicationViewModel_HiltModules;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.android_template_ui_MedicationViewModel, MedicationViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String android_template_ui_MedicationViewModel = "android.template.ui.MedicationViewModel";

      @KeepFieldType
      MedicationViewModel android_template_ui_MedicationViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.medicationViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.android_template_ui_MedicationViewModel, ((Provider) medicationViewModelProvider)));
    }
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    @Override
    public void injectMedicationReminderReceiver(
        MedicationReminderReceiver medicationReminderReceiver) {
      injectMedicationReminderReceiver2(medicationReminderReceiver);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // android.template.ui.MedicationDatabase 
